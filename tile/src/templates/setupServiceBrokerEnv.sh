...
export SERVICEBROKER_PLANID=TEMPLATE_SERVICEBROKER_PLANID
export SERVICEBROKER_SERVICEID=TEMPLATE_SERVICEBROKER_SERVICEID
export account_name=TEMPLATE_account_name
