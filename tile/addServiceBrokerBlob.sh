...
function usage() {
  ...
  echo ""
  echo "Example: ./addBlob.sh my-service-broker.jar appdynamics-service-broker "
  echo "This would add the 'my-service-broker.jar' as blob under 'blobs/appdynamics-service-broker' "
  echo ""
}
